  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Mid CTA */}
        <section className="text-center py-16 bg-gradient-to-br from-stone-800 to-stone-900 rounded-2xl mb-16">
          ...
          <Link
            href="/create"
            className="inline-block px-8 py-4 bg-white text-stone-800 rounded-xl font-medium text-lg hover:bg-stone-100 transition-colors"
          >
            Start Creating Now
          </Link>
        </section>
